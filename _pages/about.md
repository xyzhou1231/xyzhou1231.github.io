...
<br>
- Bosong Chai, Xuan Nie*, Qifan Zhou, **Xingyu Zhou**. Enhanced Cascade R-CNN for Multi-scale Object Detection in Dense Scenes from SAR Images (SCI, IEEE Sensors Journa, JCRQ1 IF=4.3)
...
<br>
- (Under Review)**Xingyu Zhou**,et al.UAVs Collaborative Route Planning Based on Improved Grey Wolf Optimisation Algorithm  (SCI, IEEE Sensors Journa, JCRQ1 IF=4.3)
<br>
